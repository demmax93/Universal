...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Apr 26 09:18:33 2016
# Project:  koshi_ui.pro
# Template: app
# Command: c:\qt\4.8.5\bin\qmake.exe -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile koshi_ui.pro
#############################################################################
...
Makefile: koshi_ui.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile koshi_ui.pro
